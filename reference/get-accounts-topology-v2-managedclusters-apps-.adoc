...
summary: 'Recuperare un"app per un cluster gestito' 
---
= Recuperare un'app per un cluster gestito
:allow-uri-read: 
...
Restituisce la risorsa API dell'app memorizzata nel corpo della risposta JSON.
