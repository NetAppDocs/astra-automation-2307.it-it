...
summary: Elenca tutti i cluster gestiti 
---
...
| elementi | array[Qualsiasi tra: link:#managedCluster_1_2_get_response_body["managedCluster_1.2_get_response_body"], array[]] | Vero  a| 
