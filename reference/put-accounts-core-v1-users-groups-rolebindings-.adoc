...
summary: 'Modificare un"associazione di ruolo per un gruppo associato a un utente' 
---
= Modificare un'associazione di ruolo per un gruppo associato a un utente
:allow-uri-read: 
:imagesdir: ../media/
