...
summary: 'Recuperare un"associazione di ruolo per un gruppo associato a un utente' 
---
= Recuperare un'associazione di ruolo per un gruppo associato a un utente
:allow-uri-read: 
:imagesdir: ../media/
