...
summary: Crea un nuovo token per un utente in un gruppo 
---
= Crea un nuovo token per un utente in un gruppo
:allow-uri-read: 
:imagesdir: ../media/
...
Indica i valori desiderati per la risorsa Token API da creare.
...
| token | stringa | Vero  a| 
Stringa JSON contenente un token API generato dal sistema e codificato in base64. I valori definiti sono:
