...
summary: 'Recupera una risorsa dell"applicazione per uno Snapshot dell"applicazione e un"app' 
---
= Recupera una risorsa dell'applicazione per uno Snapshot dell'applicazione e un'app
:allow-uri-read: 
:imagesdir: ../media/
