...
summary: Elenca tutti i backend di archiviazione 
---
...
| elementi | array[Qualsiasi tra: link:#storageBackend_1_3_get_response_body["storageBackend_1.3_get_response_body"], array[]] | Vero  a| 
