...
summary: Recuperare un cluster gestito 
---
= Recuperare un cluster gestito
:allow-uri-read: 
:imagesdir: ../media/
...
Restituisce la risorsa API del Managed Cluster memorizzata nel corpo della risposta JSON.
