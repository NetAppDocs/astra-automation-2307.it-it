...
Restituisce la risorsa API Event memorizzata nel corpo della risposta JSON.
...
| ID evento | stringa | percorso | Vero  a| 
ID della raccolta di eventi da elencare
