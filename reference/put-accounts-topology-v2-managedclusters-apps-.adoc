...
summary: 'Modificare un"app per un cluster gestito' 
---
= Modificare un'app per un cluster gestito
:allow-uri-read: 
...
| forceUpdate | stringa | intestazione | Falso  a| 
Flag che abilita le sovrascritture distruttive. Includerlo solo quando si richiede un rispristino in-place (IPR).
