...
summary: 'Recuperare una risorsa AppMirror per un"app' 
---
= Recuperare una risorsa AppMirror per un'app
:allow-uri-read: 
:imagesdir: ../media/
...
Restituisce la risorsa API AppMirror memorizzata nel corpo della risposta JSON.
