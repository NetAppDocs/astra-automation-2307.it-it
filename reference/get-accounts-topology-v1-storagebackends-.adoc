...
summary: Recuperare un backend di archiviazione 
---
= Recuperare un backend di archiviazione
:allow-uri-read: 
:imagesdir: ../media/
...
Restituisce la risorsa Storage Backend API memorizzata nel corpo della risposta JSON.
