...
summary: 'Recuperare una risorsa dell"applicazione da un backup dell"applicazione per un"app' 
---
= Recuperare una risorsa dell'applicazione da un backup dell'applicazione per un'app
:allow-uri-read: 
