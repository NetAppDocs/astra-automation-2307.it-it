...
summary: 'Elenca le risorse dell"applicazione per uno snapshot dell"applicazione' 
---
= Elenca le risorse dell'applicazione per uno snapshot dell'applicazione
:allow-uri-read: 
:imagesdir: ../media/
...
ID della risorsa appSnap contenitore
