...
summary: Recupera una pianificazione 
---
...
Restituisce la risorsa API Schedule memorizzata nel corpo della risposta JSON.
...
| schedule_id | stringa | percorso | Vero  a| 
ID della raccolta di programmi da elencare
