...
keywords:  
summary: È possibile elencare i cluster disponibili in un cloud specifico. 
---
= Elencare i cluster
:hardbreaks:
:allow-uri-read: 
...
Eseguire il flusso di lavoro link:../workflows_infra/wf_list_clouds.html["Elencare i cloud"] e seleziona il cloud che contiene i cluster.
...
| OTTIENI | /accounts/{account_id}/topology/v1/cloud/{cloud_id}/cluster 
|===
